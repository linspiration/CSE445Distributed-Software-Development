<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tryItTipCalculation.aspx.cs" Inherits="tryItTipCalculation" %>
...
<body>
    ...
    <div>
        ...
        <strong><span class="auto-style1">welcome to the test client of Tip Calculation Service!</span></strong></div>
    <p>
        <strong><span class="auto-style2">Tip calculation service</span>:</strong>Calculate the tip payment information in restaurant.</p>
    <p>
            <span class="auto-style2"><strong>Operation</strong></span>: string[] tipCalculation(int numberOfGuests, double tipRate, double billTotal, double tax, double billDeduction)<span class="auto-style2"><strong> Input</strong></span>: five strings <span class="auto-style2"><strong>Output</strong></span>: tip message</p>
        <p class="auto-style3">
